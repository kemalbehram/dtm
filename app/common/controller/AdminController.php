...
class AdminController extends BaseController
{
    ...
    protected $all_address;

    protected $all_income;

    protected $all_dynamic;

    public function __construct(App $app)
    {
        parent::__construct($app);
        $this->all_address = sysconfig('address');
        $this->all_income = sysconfig('income');
        $this->all_dynamic = sysconfig('dynamic');
    }
     ...
     * 小按钮首页
     */
    public function min_menu_index($class){
        ...
        if ($this->request->isAjax()) {
            ...
            $count = $class::where($map)
                ->count();
            $list = $class::where($map)
                ->select();
            $data = [
                'code'  => 0,
                'msg'   => '',
     ...
     * 小按钮编辑
     */
    public function min_menu_edit($class)
    {
        $row = $class::find($this->request->param('id'));
